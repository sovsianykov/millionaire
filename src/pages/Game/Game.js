  ...
  return (
    <div className={styles.game}>
      <main className={styles.main}>
          <div className={styles.menuIconWrapper} onClick={() =>setActive(!active)}>
              { active ? <img src={CloseMenuIcon} alt="CloseMenu" className={styles.icon}/>
                  : <img src={MenuIcon} alt="menu" className={styles.icon}/>
              }
          </div>
          {active ? <MenuMobile turn={turn}/> :<>
